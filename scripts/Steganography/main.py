...
print("\n The size of the image before encryption : {} bytes".format(os.stat('my.jpg').st_size))
...
print("\n The size of the image after decryption : {} bytes".format(os.stat('my_new_image.png').st_size))
