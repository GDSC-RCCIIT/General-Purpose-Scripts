...
def find_forcast (city):
    ...
    if lat is not None and long is not None:
        ...
        data['weather'][0]['main'],data['main']['temp'],data['main']['temp_max'],data['main']['temp_min'],data['main']['humidity']))
    else:
...
if (len(sys.argv)==2):
    ...
    print("too less arguement or too more ... please give a valid city name as cli")
