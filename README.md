...
53| Auto Directory Manager | Automatically move folder from one directory to another | [Find me here](https://github.com/GDSC-RCCIIT/General-Purpose-Scripts/tree/main/scripts/Auto-Directory-Manager) |
